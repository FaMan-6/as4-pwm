...
import "package:myapp/constants/theme/schedule_theme.dart";
...
class MaterialTheme {
  ...
  ThemeData light() {
    return theme(lightScheme(), isDark: false);
  }
  ...
  ThemeData dark() {
    return theme(darkScheme(), isDark: true);
  }
  ...
  ThemeData theme(ColorScheme colorScheme, {bool isDark = false}) => ThemeData(
    useMaterial3: true,
    ...
    extensions: [isDark ? ScheduleColors.dark : ScheduleColors.light],
  );
